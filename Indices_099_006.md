...
| **Index #** | **Index** | **Index description** | **Valid cluster metric?** | **Minimum number of neighbour sets** | **Formula** |
|:------------|:----------|:----------------------|:--------------------------|:-------------------------------------|:------------|
| 208 | PMPD2\_MAX | Maximum of pairwise phylogenetic distances |   | 1 |   |
| 209 | PMPD2\_MEAN | Mean of pairwise phylogenetic distances |   | 1 | <img src='http://latex.codecogs.com/png.latex?MPD = \frac {\sum_{t_i = 1}^{n_t-1} \sum_{t_j = 1}^{n_t} d_{t_i \leftrightarrow t_j}}{(n_t-1)^2}, i \neq j%.png' title='MPD = \frac {\sum_{t_i = 1}^{n_t-1} \sum_{t_j = 1}^{n_t} d_{t_i \leftrightarrow t_j}}{(n_t-1)^2}, i \neq j' /> where <img src='http://latex.codecogs.com/png.latex?d_{t_i \leftrightarrow t_j} = \sum_{b \in B_{t_i \leftrightarrow t_j}} L_b%.png' title='d_{t_i \leftrightarrow t_j} = \sum_{b \in B_{t_i \leftrightarrow t_j}} L_b' /> is the sum of the branch lengths along the path connecting <img src='http://latex.codecogs.com/png.latex?t_i%.png' title='t_i' /> and<img src='http://latex.codecogs.com/png.latex?t_j%.png' title='t_j' /> such that <img src='http://latex.codecogs.com/png.latex?L_b%.png' title='L_b' /> is the length of each branch in the set of branches<img src='http://latex.codecogs.com/png.latex?B%.png' title='B' />  |
| 210 | PMPD2\_MIN | Minimum of pairwise phylogenetic distances |   | 1 |   |
| 211 | PMPD2\_N | Count of pairwise phylogenetic distances |   | 1 |   |
| 212 | PMPD2\_RMSD | Root mean squared pairwise phylogenetic distances |   | 1 |   |
| 213 | PNTD2\_MAX | Maximum of nearest taxon distances |   | 1 |   |
| 214 | PNTD2\_MEAN | Mean of nearest taxon distances |   | 1 |   |
| 215 | PNTD2\_MIN | Minimum of nearest taxon distances |   | 1 |   |
| 216 | PNTD2\_N | Count of nearest taxon distances |   | 1 |   |
| 217 | PNTD2\_RMSD | Root mean squared nearest taxon distances |   | 1 |   |
...
| **Index #** | **Index** | **Index description** | **Valid cluster metric?** | **Minimum number of neighbour sets** | **Formula** |
|:------------|:----------|:----------------------|:--------------------------|:-------------------------------------|:------------|
| 218 | PMPD1\_MAX | Maximum of pairwise phylogenetic distances |   | 1 |   |
| 219 | PMPD1\_MEAN | Mean of pairwise phylogenetic distances |   | 1 | <img src='http://latex.codecogs.com/png.latex?MPD = \frac {\sum_{t_i = 1}^{n_t-1} \sum_{t_j = 1}^{n_t} d_{t_i \leftrightarrow t_j}}{(n_t-1)^2}, i \neq j%.png' title='MPD = \frac {\sum_{t_i = 1}^{n_t-1} \sum_{t_j = 1}^{n_t} d_{t_i \leftrightarrow t_j}}{(n_t-1)^2}, i \neq j' /> where <img src='http://latex.codecogs.com/png.latex?d_{t_i \leftrightarrow t_j} = \sum_{b \in B_{t_i \leftrightarrow t_j}} L_b%.png' title='d_{t_i \leftrightarrow t_j} = \sum_{b \in B_{t_i \leftrightarrow t_j}} L_b' /> is the sum of the branch lengths along the path connecting <img src='http://latex.codecogs.com/png.latex?t_i%.png' title='t_i' /> and<img src='http://latex.codecogs.com/png.latex?t_j%.png' title='t_j' /> such that <img src='http://latex.codecogs.com/png.latex?L_b%.png' title='L_b' /> is the length of each branch in the set of branches<img src='http://latex.codecogs.com/png.latex?B%.png' title='B' />  |
| 220 | PMPD1\_MIN | Minimum of pairwise phylogenetic distances |   | 1 |   |
| 221 | PMPD1\_N | Count of pairwise phylogenetic distances |   | 1 |   |
| 222 | PMPD1\_RMSD | Root mean squared pairwise phylogenetic distances |   | 1 |   |
| 223 | PNTD1\_MAX | Maximum of nearest taxon distances |   | 1 |   |
| 224 | PNTD1\_MEAN | Mean of nearest taxon distances |   | 1 |   |
| 225 | PNTD1\_MIN | Minimum of nearest taxon distances |   | 1 |   |
| 226 | PNTD1\_N | Count of nearest taxon distances |   | 1 |   |
| 227 | PNTD1\_RMSD | Root mean squared nearest taxon distances |   | 1 |   |
...
| **Index #** | **Index** | **Index description** | **Valid cluster metric?** | **Minimum number of neighbour sets** |
|:------------|:----------|:----------------------|:--------------------------|:-------------------------------------|
| 333 | NEST\_RESULTANT | Nestedness-resultant index | cluster metric | 1 |
...
| **Index #** | **Index** | **Index description** | **Valid cluster metric?** | **Minimum number of neighbour sets** |
|:------------|:----------|:----------------------|:--------------------------|:-------------------------------------|
| 334 | TX\_RAO\_QE | Taxonomically weighted quadratic entropy |   | 1 |
| 335 | TX\_RAO\_TLABELS | List of labels and values used in the TX\_RAO\_QE calculations |   | 1 |
| 336 | TX\_RAO\_TN | Count of comparisons used to calculate TX\_RAO\_QE |   | 1 |
...
| **Index #** | **Index** | **Index description** | **Valid cluster metric?** | **Minimum number of neighbour sets** | **Formula** |
|:------------|:----------|:----------------------|:--------------------------|:-------------------------------------|:------------|
| 338 | SHANNON\_E | Shannon's evenness (H / HMAX) |   | 1 | <img src='http://latex.codecogs.com/png.latex?Evenness = \frac{H}{HMAX}%.png' title='Evenness = \frac{H}{HMAX}' />  |
| 339 | SHANNON\_H | Shannon's H |   | 1 | <img src='http://latex.codecogs.com/png.latex?H = - \sum^n_{i=1} (p_i \cdot ln (p_i))%.png' title='H = - \sum^n_{i=1} (p_i \cdot ln (p_i))' />  |
| 340 | SHANNON\_HMAX | maximum possible value of Shannon's H |   | 1 | <img src='http://latex.codecogs.com/png.latex?HMAX = ln(richness)%.png' title='HMAX = ln(richness)' />  |
| 341 | SIMPSON\_D | Simpson's D. A score of zero is more similar. |   | 1 | <img src='http://latex.codecogs.com/png.latex?D = 1 - \sum^n_{i=1} p_i^2%.png' title='D = 1 - \sum^n_{i=1} p_i^2' />  |
