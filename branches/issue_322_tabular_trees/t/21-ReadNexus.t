...

{
    ...
    my $read_file = 'tabular_export.csv';
    my $output_file = 'test_tabular_export.csv';
    
    # define map to read sample file
    my $field_map = {TREENAME_COL => 9, 
    ...
    if ($EVAL_ERROR) { print "error $EVAL_ERROR\n"; }
    is ($result, 1, 'export tabular tree');

    # re-import
    my $reimport_ref = Biodiverse::ReadNexus->new;
    my $reimport_map = {TREENAME_COL => 6, 
