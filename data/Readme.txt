...
(note that randomisations cannot be extended between architectures due to the random number generator library being used, hence this basedata file is labelled for 64 bit systems)
