...
use constant CELL_BLACK       => Gtk3::Gdk::Color::parse(0, 0, 0);
use constant CELL_WHITE       => Gtk3::Gdk::Color::parse(255*257, 255*257, 255*257);
...
sub get_colour_hue {
    ...
    if (! defined $max || ! defined $min) {
        return Gtk3::Gdk::Color::parse(0, 0, 0);
    }
    elsif ($max != $min) {
