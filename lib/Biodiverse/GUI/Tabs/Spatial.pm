...
use constant COLOUR_GRAY  => [Gtk3::Gdk::Color::parse(sprintf '#%x%x%X', 210*257, 210*257, 210*257)]->[1];
use constant COLOUR_RED   => [Gtk3::Gdk::Color::parse('red')]->[1];
#use constant COLOUR_FAILED_DEF_QUERY => Gtk3::Gdk::Color::parse((0.9 * 255 * 257) x 3); # same as cluster grids
use constant COLOUR_FAILED_DEF_QUERY => [Gtk3::Gdk::Color::parse('white')]->[1];
...
sub new {
    ...
    $self->{hue} = [Gtk3::Gdk::Color::parse('red')]->[1]; # red, for Sat mode
...
my @dendro_highlight_branch_colours
  = map {[Gtk3::Gdk::Color::parse($_)]->[1]} ('#1F78B4', '#E31A1C', '#000000');
