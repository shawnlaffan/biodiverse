Heavy.pm.patch needs to be applied to C:\strawberry\perl\vendor\lib\PAR\Heavy.pm
...
This patch doesn't change the behaviour. It is just needed to make it build under x86_64.
